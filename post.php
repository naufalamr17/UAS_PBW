...
if (isset($_POST['searchBox'])) {
    $cari = $_POST['searchBox'];
    if ($cari != "") {
        $query = mysqli_query($koneksi, "select * from tb_gambar where nama_gambar like '%" . $cari . "%'");
                            ...
                            <div class="col-lg-12">
                                <div class="blog-post">
                                    <div class="blog-thumb">
                                        <img src="image_view.php?id_gambar= <?php echo $row['id_gambar']; ?>" />
                                    </div>
                                    <div class="down-content">
                                        <a href="post-details.php?id=<?php echo $row['id_gambar']; ?>">
                            ...
                            <div class="col-lg-12">
                                <div class="sidebar-item search">
                                    <form action="post.php" method="POST">
                                        <input type="text" name="searchBox" class="searchText" placeholder="type to search...">
                                    </form>
                                </div>
                            </div>
                            <div class="col-lg-12">
